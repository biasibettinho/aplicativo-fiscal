...
import { 
  Plus, Search, History, Clock, Loader2, Calendar, CreditCard, Landmark, Edit3, Send, Paperclip, FileText, Banknote, X, CheckCircle
} from 'lucide-react';
    ...
    try {
      ...
      if (invoiceFiles.length > 0) {
        ...
        for (let i = 0; i < invoiceFiles.length; i++) {
          ...
          await sharepointService.uploadAttachment(authState.token, mainListId, itemId, invoiceFiles[i]);
        }
      }
      ...
      if (ticketFiles.length > 0) {
        ...
        for (let i = 0; i < ticketFiles.length; i++) {
          ...
          await sharepointService.uploadAttachment(authState.token, auxListId, auxItem.id, ticketFiles[i]);
        }
      }
